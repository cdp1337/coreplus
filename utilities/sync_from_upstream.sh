...
rsync $OPTIONS "$UPSTREAM/src/htaccess.assets" "$BASEDIR/src/"
rsync $OPTIONS "$UPSTREAM/src/htaccess.private" "$BASEDIR/src/"
rsync $OPTIONS "$UPSTREAM/src/htaccess.public" "$BASEDIR/src/"
