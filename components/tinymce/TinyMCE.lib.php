...
<script type="text/javascript">
	$(function(){
		$('textarea.tinymce').tinymce({
			...
			theme_advanced_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,/*template,*/pagebreak,|,preview,fullscreen,cleanup,code,|,help",
