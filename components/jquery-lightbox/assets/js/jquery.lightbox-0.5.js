 ...
 * @changelog
 *
 * 0.5~core1 - 2012.07.11
 * Updated logic slightly to not require actual images, but instead use the font-awesome library, which will
 * ship by default with Core+.
 */
	...
	$.fn.lightBox = function(settings) {
		...
		function _set_interface() {
			...
			$('body').append(
				...
				'<div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a>' +
				'<a href="#" id="lightbox-nav-btnNext"></a></div>' +
				'<div id="lightbox-loading"><a href="#" id="lightbox-loading-link">Loading...</a></div>' +
				'</div>' +
				'</div>' +
				'<div id="lightbox-container-image-data-box">' +
				'<div id="lightbox-container-image-data">' +
