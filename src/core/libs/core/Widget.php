...
class Widget {
	...
	/**
	 * Array of the settings required by this widget; useful for "simple" widgets.
	 *
	 * For simple widgets, Core will handle content management via the built-in interfaces.
	 * 
	 * Widget instances share the same settings; and multiple widgets can be defined,
	 * each with their own instanced settings.
	 *
	 * @var array
	 */
	public $settings = [];
	...
	public function getPreviewImage(){
		// Override this in the extending method to return a different image.
		return 'assets/images/placeholders/generic.png';
	}
	
	/**
	 * Get the requested display setting value, or NULL if it does not exist.
	 * 
	 * @param string $key
	 * 
	 * @return mixed
	...
	public static function HookPageRender(){
		...
		if($template === null){
			// if the template is not located, then null can't have any widgets.
			return true;
		}
