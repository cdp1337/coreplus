...
if (!class_exists('Smarty_Internal_Data', false)) {
    require_once __DIR__ . '/sysplugins/smarty_internal_data.php';
}
require_once __DIR__ . '/sysplugins/smarty_internal_templatebase.php';
require_once __DIR__ . '/sysplugins/smarty_internal_template.php';
require_once __DIR__ . '/sysplugins/smarty_resource.php';
require_once __DIR__ . '/sysplugins/smarty_variable.php';
require_once __DIR__ . '/sysplugins/smarty_template_source.php';
