...
class PHPMailer {
	...
	public function getReplyToAddresses(){
		return $this->_getAddresses('replyto');
	}

	/**
	 * Get a list of addresses as an array
	 *
	 ...
	 */
	protected function _getAddresses($kind){
		switch($kind){
			case 'to':
				return $this->to;
			case 'cc':
				...
				if ($this->smtp->Connect(($ssl ? 'ssl://' : '') . $host, $port, $this->Timeout)) {
					...
					if ($this->SMTPAuth) {
						if (!$this->smtp->Authenticate(
							$this->Username, $this->Password, $this->AuthType,
