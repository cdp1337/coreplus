		...
		if(isset($blocks['domain'])) {
			...
			if(isset($blocks['owner'])) {
				...
				if(isset($blocks['tech'])) $r['regrinfo']['tech'] =
					\phpwhois\generic_parser_b($blocks['tech'], $translate, 'dmy', false);

				if(isset($blocks['admin'])) $r['regrinfo']['admin'] =
					\phpwhois\generic_parser_b($blocks['admin'], $translate, 'dmy', false);

				if(isset($blocks['billing'])) $r['regrinfo']['billing'] =
					\phpwhois\generic_parser_b($blocks['billing'], $translate, 'dmy', false);
			}
			else {
