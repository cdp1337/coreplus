<?php
/**
 * whois registration file for edu. TLD
 *
 * @package phpwhois
 *
...
if(!defined('__EDU_HANDLER__')) define('__EDU_HANDLER__', 1);
...
class edu_handler {
	function parse($data_str, $query) {
		...
		if(isset($b['tech'])) {
			if($r['regrinfo']['tech']['name'] == 'Same as above') $r['regrinfo']['tech'] = $r['regrinfo']['admin'];
		}
