...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<style>
			...
			pre { background:black; border:1px solid #3F3; padding:1em 2em; border-radius:5px; -moz-border-radius:5px; -webkit-border-radius:5px; color:#3F3; font-size:10pt; font-family:monospace;}
