...
### getUserAgent
    ...
    \Core\UserAgent SystemLogModel::getUserAgent()
...
### LogSecurityEvent
    ...
    mixed SystemLogModel::LogSecurityEvent(string $code, string $message, string $details, null|integer $affected_user)
...
#### Arguments
* $code **string** - &lt;p&gt;Any code that may be associated to this event.&lt;/p&gt;
* $message **string** - &lt;p&gt;The subject of the security event.&lt;/p&gt;
* $details **string** - &lt;p&gt;Any additional details of the security event beyond the subject line.&lt;/p&gt;
* $affected_user **null|integer** - &lt;p&gt;If this security event affected a given user, the affected user&#039;s id.&lt;/p&gt;



### LogErrorEvent

    mixed SystemLogModel::LogErrorEvent(string $code, string $message, string $details)
...
#### Arguments
* $code **string** - &lt;p&gt;Any code that may be associated to this event.&lt;/p&gt;
* $message **string** - &lt;p&gt;The subject of the error event.&lt;/p&gt;
* $details **string** - &lt;p&gt;Any additional details of the error event beyond the subject line.&lt;/p&gt;



### LogInfoEvent

    mixed SystemLogModel::LogInfoEvent(string $code, string $message, string $details)
...
#### Arguments
* $code **string** - &lt;p&gt;Any code that may be associated to this event.&lt;/p&gt;
* $message **string** - &lt;p&gt;The subject of the info event.&lt;/p&gt;
* $details **string** - &lt;p&gt;Any additional details of the info event beyond the subject line.&lt;/p&gt;



### Factory

    \SystemLogModel SystemLogModel::Factory()
