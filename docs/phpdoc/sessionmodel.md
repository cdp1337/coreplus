...
### getExternalData
    ...
    array SessionModel::getExternalData()
...
### setData
    ...
    mixed SessionModel::setData($data)
...
#### Arguments
* $data **mixed** - &lt;p&gt;mixed Uncompressed data&lt;/p&gt;



### setExternalData

    mixed SessionModel::setExternalData(array $data)
...
#### Arguments
* $data **array** - &lt;p&gt;External data to set&lt;/p&gt;
