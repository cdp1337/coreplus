...
### setValue
    ...
    mixed ConfigModel::setValue($value)
...
### TranslateValue
    ...
    array|boolean|integer ConfigModel::TranslateValue($type, $value)
...
### getFormAttributes
    ...
    mixed ConfigModel::getFormAttributes()
...
### getAsFormElement
    ...
    \FormElement ConfigModel::getAsFormElement()
...
### asFormElement
    ...
    \FormElement ConfigModel::asFormElement()
