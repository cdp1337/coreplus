...
* Class name: DatastoreAuthController
* Namespace: 
...
### password
    ...
    integer DatastoreAuthController::password()
...
### forgotPassword
    ...
    mixed DatastoreAuthController::forgotPassword()
...
### disable
    ...
    integer DatastoreAuthController::disable()
...
### _forgotPassword1
    ...
    mixed DatastoreAuthController::_forgotPassword1()
...
### _forgotPassword2
    ...
    mixed DatastoreAuthController::_forgotPassword2()
...
### RegisterHandler
    ...
    boolean|string DatastoreAuthController::RegisterHandler(\Form $form)
...
### LoginHandler
    ...
    boolean|null|string DatastoreAuthController::LoginHandler(\Form $form)
...
### GetUserControlLinks
    ...
    array DatastoreAuthController::GetUserControlLinks(integer $userid)
