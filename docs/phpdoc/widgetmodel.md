...
### getSetting
    ...
    mixed WidgetModel::getSetting($key)
...
### setSetting
    ...
    mixed WidgetModel::setSetting($key, $value)
...
### getWidget
    ...
    \Widget_2_1|null WidgetModel::getWidget()
...
### SplitBaseURL
    ...
    array WidgetModel::SplitBaseURL(string $base)
