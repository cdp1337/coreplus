...
* Class name: WidgetInstanceModel
* Namespace: 
...
### splitParts
    ...
    array WidgetInstanceModel::splitParts()
...
### getWidget
    ...
    \Widget_2_1|null WidgetInstanceModel::getWidget()
...
### getAlternativeTemplateOptions

    array WidgetInstanceModel::getAlternativeTemplateOptions()
...
### execute
    ...
    \View WidgetInstanceModel::execute(array $parameters)
...
#### Arguments
* $parameters **array** - &lt;p&gt;Array of custom parameters passed in from the template&lt;/p&gt;
