...
### isBot
    ...
    boolean UserActivityModel::isBot()
...
### getUserAgent
    ...
    \Core\UserAgent UserActivityModel::getUserAgent()
...
### getDisplayName
    ...
    mixed UserActivityModel::getDisplayName()
...
### getTimeFormatted
    ...
    string UserActivityModel::getTimeFormatted()
