...
### getPermissions
    ...
    array UserGroupModel::getPermissions()
...
### setPermissions
    ...
    mixed UserGroupModel::setPermissions($permissions)
...
### _validateName
    ...
    mixed UserGroupModel::_validateName($key)
...
### Import
    ...
    \Core\ModelImportLogger UserGroupModel::Import(array $data, array $options, boolean $output_realtime)
