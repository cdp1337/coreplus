...
* Class name: UserGroupAdminController
* Namespace: 
...
### __construct
    ...
    mixed UserGroupAdminController::__construct()
...
### index
    ...
    mixed UserGroupAdminController::index()
...
### create
    ...
    mixed UserGroupAdminController::create()
...
### update
    ...
    mixed UserGroupAdminController::update()
...
### delete
    ...
    mixed UserGroupAdminController::delete()
...
### _setPermissionsToForm

    mixed UserGroupAdminController::_setPermissionsToForm(\Form $form, \UserGroupModel $model)
...
#### Arguments
* $form **[Form](form.md)**
* $model **[UserGroupModel](usergroupmodel.md)**



### _UpdateFormHandler

    mixed UserGroupAdminController::_UpdateFormHandler(\Form $form)
