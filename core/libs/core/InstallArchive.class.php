...
class InstallArchive{
		...
		if(is_null($this->_signature)){
			...
			switch($this->_file->getMimetype()){
				case 'application/pgp':
					...
					break;
				default:
					$this->_signature = array('state' => InstallArchive::SIGNATURE_NONE, 'key' => null, 'email' => null, 'name' => null);
					break;
			}
		}
	...
	private function _checkGPGSignature(){
		...
		try{
			...
			return array('state' => InstallArchive::SIGNATURE_INVALID, 'key' => null, 'email' => null, 'name' => null);
		}
